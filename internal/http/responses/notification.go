...
func IncorrectNotificationId(c *gin.Context, err error) {
	Basic(c, http.StatusBadRequest, gin.H{"message": "incorrect notification id format"})
}

func extractMyNotificationData(notification *models.NotificationModel) gin.H {
	return gin.H{
